class ContaBancaria:
    ...
    def __init__(self, id, nome, saldo=0):
        ...
        self.nome = nome
        self.saldo = saldo
        print(f"\033[1;33mConta {self.id} criada com sucesso. Saldo atual de R${self.saldo:,.2f}\033[m")

    def depositar(self, valor):
        self.saldo += valor
        print(f"\033[1;32mDepósito de R${valor:,.2f} autorizado na conta {self.id}.\033[m")
